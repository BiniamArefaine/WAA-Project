...
SET foreign_key_checks = 0;
insert into user values(1,'eyob@gmail.com','bini','Habtom','ey0123',0,1,1);
SET foreign_key_checks = 0;
insert into product values(1,'perfect product','322868_1100-1100x628.jpg','car',0,0,20000.00,'2020-03-02',1);
...
-- insert into user values(2,'bini@gmail.com','eyob','Tshaye','bi0234','biniam',0,1,2);
